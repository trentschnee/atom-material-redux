...
interface IMaterialUIIconProps extends ISVGIconProps {
}

const MaterialUIIcon: React.FunctionComponent<IMaterialUIIconProps> = (props) => {
    return (<SVGIcon viewBox="0 0 256 204">
